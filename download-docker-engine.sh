...
apt_config_url="https://229cf97bdb38afa57b74c0f1e1be9fd925d4af5e5a2f4dfb:@packagecloud.io/install/repositories/Docker/cs/config_file.list?os=${os}&dist=${dist}&name=${host}&source=script"
